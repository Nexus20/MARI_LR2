...
# --- PSO with trajectory tracking for animation ---
...
if __name__ == "__main__":
    ...
    # АНІМАЦІЯ: Візуалізація траєкторій частинок
    print("\n" + "="*80)
    ...
    cfg_animation = PSOConfig(
        n_particles=30,  # Трохи менше для кращої видимості
        w=0.7,
        c1=1.5,
        c2=1.5,
    ...
    print("\nСтворення анімації...")
    print("(для збереження у файл розкоментуйте параметр save_path)")
    ...
    animate_pso_2d(
        ...
        bounds=bounds_zoom,
        f=griewank,
        save_path=None,  # Змініть на "pso_animation.gif" для збереження
